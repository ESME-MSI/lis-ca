                  ...
                  <div class="col-md-8">
                    <div class="mb-4">
                      <h2><strong>S'inscrire</strong><h2>
                        <p class="mb-4">Renseignez vos informations pour commencer à scanner vos documents</p>
                      </div>
                      <form action="#" method="post">
                        ...
                        <input type="submit" value="S'inscrire" class="btn text-white btn-block btn-primary button-30">
                        
                        <div class="d-flex mb-5 align-items-center">
                        </label>
                        <span class="ml-auto"><a href="login.php" class="forgot-pass">Se connecter</a></span>
                      </div>
