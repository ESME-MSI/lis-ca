          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                ...
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Vos retours sont importants pour nous améiorer</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row mb-5 align-items-end">
          <div class="col-md-6" data-aos="fade-up">
            ...
            <h2>Formulaire</h2>
            <p class="mb-0">Renseignez vos informations pour nous faire part de votre retour</p>
          </div>
        ...
        <div class="row">
          <div class="col-md-4 ms-auto order-2" data-aos="fade-up">
            <ul class="list-unstyled">
              ...
              <li class="mb-3">
                <strong class="d-block mb-1">Téléphone</strong>
          ...
          <div class="col-md-6 mb-5 mb-md-0" data-aos="fade-up">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group">
                  <input type="submit" class="btn btn-primary d-block w-100" value="Envoyer message">
                </div>
              </div>
    ...
    <section class="section border-top border-bottom">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-4">
            <h2 class="section-heading">Retours des utilisateurs</h2>
          </div>
        </div>
